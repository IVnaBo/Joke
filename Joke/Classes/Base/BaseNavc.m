...
@interface BaseNavc ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.viewControllers.count > 0) {
        ...
        if (self.viewControllers.count > 0) {
            ...
            [btn setBackgroundImage:[UIImage imageNamed:@"news_back_icon"] forState:UIControlStateNormal];
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    //        if ([view isKindOfClass:[LoginCtr class]]) {
    //            return NO;
    //        }
    //    }
